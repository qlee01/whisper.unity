...
build_android() {
  ...
  cmake -DCMAKE_TOOLCHAIN_FILE="$android_sdk_path" -DCMAKE_BUILD_TYPE=Release -DBUILD_TARGET="android" -DANDROID_ABI=arm64-v8a -DANDROID_PLATFORM=android-34 -DBUILD_SHARED_LIBS=OFF \
  -DWHISPER_BUILD_TESTS=OFF -DWHISPER_BUILD_EXAMPLES=OFF ../
  make
